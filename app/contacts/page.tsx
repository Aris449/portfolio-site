...
const Contacts = () => {
    return (
        ...
        <div className="flex justify-center items-center min-h-[calc(100vh-14rem)]">
            <div className="flex flex-col justify-center md:w-xl lg:h-80 bg-bg rounded-2xl border border-[hsl(0,0%,20%)]">
                <div className="flex flex-col justify-center m-20 gap-4">
                    ...
                    <Link href="/about" className="flex justify-center items-center bg-bg-light p-4 my-1 md:my-4 rounded-2xl w-40 text-xl font-bold border border-[hsl(0,0%,20%)]">contract</Link>
                </div>
            </div>
        </div>
        </AnimatedWrapper>
